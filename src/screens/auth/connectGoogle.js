...
export default class ConnectGoogle extends Component {
    constructor(props) {
        super(props)
    ...
    initialGoogle = async () => {
        ...
        await GoogleSignIn.signInPromise().then((user) => {
            alert('Connected to your Google Drive successfully')
            this.gotoHome()
        });
    ...
    render() {
        return (
            <View style={styles.container}>
                <Text style={styles.caption}>Cloud Storage Connect</Text>
                ...
                <TouchableHighlight style={styles.buttonGoHome} onPress={this.gotoHome}>
                    <Text style={styles.text}>
                        Go home
                    </Text>
                </TouchableHighlight>
...
const styles = StyleSheet.create({
    ...
    buttonGoHome: {
        backgroundColor: 'rgba(195,195,195,0.70)',
        borderRadius: 20,
        height: 44,
        minWidth: 120,
        display: 'flex',
